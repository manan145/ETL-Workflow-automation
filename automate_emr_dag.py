...
job_flow_overrides = {
    ...
    "LogUri": "s3://redfin-data-bucket-mj/emr-logs-yml/",
    ...
    "Instances": {
        ...
        "Ec2SubnetId": "subnet-09a291927ccf31b79",
...
SPARK_STEPS_EXTRACTION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                "s3://redfin-data-bucket-mj/scripts/ingest.sh",
            ],
        },
    },
   ]
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit",
            "s3://redfin-data-bucket-mj/scripts/transform_redfin_data.py",
            ],
        },
    },
   ]
